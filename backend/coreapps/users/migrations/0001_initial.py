    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=255, unique=True, verbose_name='Mail address')),
            ...
            managers=[
                ('objects', coreapps.users.models.CustomUserManager()),
            ],
        ),
    ]
